  ...
  return (
    <>
      <footer className=" bg-black items-center">
        ...
        <hr class="h-px bg-gray-100 border-0 text-[#8B8989]" />
        <div className="flex justify-center items-center p-10">
          <p className="text-center text-[#8B8989] font-sans tracking-wide text-sm sm:text-sm md:text-base lg:text-lg">
            AI was used to make this page. © 2024 House of Models
          </p>
        </div>
      </footer>
    </>
